...
def draw():
    global lairs, eggs_collected, lives, game_complete, game_over
    screen.clear()
...
# You'll need to add your game logic and event handling to the update and on_mouse_down functions.
